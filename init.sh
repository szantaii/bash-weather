...
init()
{
	...
	ascii_icon_mist[1]="    ,o*************'.             ..    "
	ascii_icon_mist[2]="   o***o',,...,'o****o',.     .,'o**o   "
	ascii_icon_mist[3]="   .''.           ,o***************o.   "
	ascii_icon_mist[4]="                    ..,'o*****oo',.     "
	ascii_icon_mist[5]="        .,,'',,.                        "
	ascii_icon_mist[6]="    .'o**********o',                    "
	ascii_icon_mist[7]="   o*****o',,''o*****o'.       .,o**o   "
	ascii_icon_mist[8]="   ,'',.         .'o****o'''''o****o,   "
	ascii_icon_mist[9]="                    .,,'o*****oo',.     "
	ascii_icon_mist[10]="        .,,',,,.                        "
	ascii_icon_mist[11]="    .'o**********o',                    "
	ascii_icon_mist[12]="   o*****o',,''o*****o'.       .,o**o   "
	ascii_icon_mist[13]="   ,'',.         .'o****o'''''o****o,   "
	ascii_icon_mist[14]="                    .'o**********'.     "
	ascii_icon_mist[15]="                       .'o***o',.       "
